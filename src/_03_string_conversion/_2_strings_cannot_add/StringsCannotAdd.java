...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			String sixAsString = JOptionPane.showInputDialog("Now enter 6.");
			...
			String fiveAsString = JOptionPane.showInputDialog("Now enter 5.");
			...
			JOptionPane.showMessageDialog(null, fiveAsInt + sixAsInt + fourAsInt);
